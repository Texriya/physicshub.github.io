...
export default function ProjectileMotionPage() {
  ...
  // This line defines inputsRef. It MUST be inside the component function.
  ...
  // We create the refs ourselves here.
  ...
  const handleInputChange = useCallback(
    ...
    [setInputs] // This dependency is correct
  );
  ...
  // The sketch function MUST be inside the component to access hooks
  const sketch = useCallback(
    (p) => { // 'p' is the p5 instance from P5Wrapper
      let trailLayer = null;
      let groundY = 0;
      let originX = 0;
      let originY = 0;
